...
* Arch Linux made by Timofey: [https://f.tx0.su/share/nabu/images/v4/12-05-25/ArchKDE-12-05-25.tgz](https://f.tx0.su/share/nabu/images/v4/12-05-25/ArchKDE-12-05-25.tgz)
...
To modify the partitions on the UFS, we'll need to download a 3rd-party recovery environment called "Orangefox Recovery" [Link is here](../download/resource-download.md).
...
Enter fastboot mode and repeat the [previous steps](https://github.com/Android-Piepaint/Linux-for-nabu-website/blob/main/installation-guide/install-ubuntu-on-your-tablet-legacy-images-only.md#partition-the-ufs).
